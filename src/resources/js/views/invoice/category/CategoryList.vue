<template>
  <div class="content-wrapper">
    ...
    <category-modal v-if="isModalActive" :table-id="tableId" modal-id="category-modal" :selected-url="selectedData"
      @close="closeModal" />
...
import CategoryModal from "@/invoice/category/CategoryModal.vue";
...
const tableId = ref('categories-table')
