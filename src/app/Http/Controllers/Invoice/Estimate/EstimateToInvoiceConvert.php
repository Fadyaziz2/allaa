...
class EstimateToInvoiceConvert extends Controller
{
    ...
    public function invoiceConvert(Estimate $estimate)
    {
        try {
            ...
            return response()->json([
                'message' => __('default.estimate_to_invoice_convert_has_been_successfully'),
                'data' => $newInvoice
            ]);

        } catch (\Exception $exception) {
            DB::rollBack();
            throw new GeneralException(__('default.estimate_to_invoice_convert_has_been_field'));
        }
